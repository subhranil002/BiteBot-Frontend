        ...
        <div className="mt-6 space-y-6">
          ...
          {currentTab === "favorites" && (
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-800">Your Favorite Recipes</h3>
              ...
              {data?.favorites?.length > 0 ? (
                ...
                <div className="card bg-base-100/80 backdrop-blur-md border border-orange-100 shadow rounded-2xl text-center p-12">
            ...
            <div className="space-y-6">
              ...
              {data?.subscriptions?.length > 0 ? (
                ...
                <div className="card bg-base-100/80 border border-orange-100 shadow-md rounded-2xl text-center p-12">
                  ...
                  <h4 className="text-lg font-semibold text-gray-800 mb-2">No subscriptions yet</h4>
                  <p className="text-gray-500 mb-4">
            ...
            <div>
              ...
              {data?.activity?.length > 0 ? (
                ...
                <div className="card bg-base-100/80 border border-orange-100 shadow-md rounded-2xl text-center p-12">
                  ...
                  <h4 className="text-lg font-semibold text-gray-800 mb-2">No activity yet</h4>
