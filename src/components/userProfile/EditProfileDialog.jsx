...
function EditProfileDialog() {
  ...
  >
    <div className="modal-box max-w-md w-full relative bg-white/80 backdrop-blur-md border border-orange-100 shadow-xl rounded-2xl p-6">
      {/* Close Button */}
      <button
        type="button"
        className="btn btn-sm btn-circle absolute right-4 top-4 bg-gradient-to-r from-orange-400 to-red-400 text-white hover:opacity-90 transition-all shadow-md"
        onClick={() => {
          const dlg = document.getElementById("edit-profile");
          dlg?.close();
        }}
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-3">
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute -bottom-2 -right-2 bg-gradient-to-r from-orange-400 to-red-400 text-white p-2 rounded-full shadow-md hover:scale-105 transition-all"
              onClick={() => {}}
        ...
        <div className="form-control w-full">
          ...
          <input
            id="name"
            className="input w-full border border-orange-200 focus:border-orange-400 focus:ring-2 focus:ring-orange-300 transition-all rounded-xl"
            value={formData.name}
        ...
        <div className="form-control w-full">
          ...
          <textarea
            id="bio"
            className="textarea w-full border border-orange-200 focus:border-orange-400 focus:ring-2 focus:ring-orange-300 transition-all rounded-xl"
            value={formData.bio}
        ...
        <div className="modal-action justify-end flex items-center gap-3 pt-4">
          <form method="dialog">
            <button
              type="submit"
              className="btn btn-ghost text-gray-600 hover:bg-orange-50 gap-2"
            >
