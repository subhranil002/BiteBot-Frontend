...
const RecipeCard = ({ recipe, className = "" }) => {
    ...
    return (
        ...
        >
            ...
            {/* Main card container */}
            <div className="relative bg-white border border-orange-100/60 rounded-3xl shadow-lg overflow-hidden transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-2xl group-hover:border-orange-200 flex flex-col h-full">
                ...
                <figure className="relative overflow-hidden h-48 md:h-56">
                    ...
                    {recipe.isTrending && (
                        <div className="absolute top-4 left-4">
                            <div className="badge bg-gradient-to-r from-orange-500 to-pink-500 text-white font-bold border-0 shadow-md backdrop-blur-sm">
                    ...
                    <button
                        ...
                        className={`absolute top-4 right-4 w-10 h-10 rounded-full border transition-all duration-300 hover:scale-110 backdrop-blur-md ${
                            isFav
                                ? "bg-gradient-to-br from-rose-500 to-pink-400 text-white border-pink-300 shadow-lg"
                ...
                <div className="flex flex-col flex-grow p-5 md:p-6 justify-between">
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm mt-2">
                            <div className="flex items-center gap-2 text-gray-500 group-hover:text-gray-700 transition-colors">
                                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center border border-blue-200">
                                    <FaUsers className="w-3 h-3 text-blue-500" />
                                </div>
                                <span>{recipe.servings} servings</span>
                            </div>
                            <div className="flex items-center gap-2 text-gray-500 group-hover:text-gray-700 transition-colors">
                                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center border border-green-200">
                                    <FaUtensils className="w-3 h-3 text-green-600" />
                                </div>
                    ...
                    {/* Button area (always bottom aligned) */}
                    <div className="pt-4">
                        <Link
                            to={`/recipe/${recipe.id}`}
