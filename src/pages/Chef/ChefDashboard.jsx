...
const MOCK_USER = {
    ...
    chefProfile: {
        ...
        experience:
            "10 years of culinary excellence specializing in Indian fusion cuisine.",
        externalLinks: [
        ...
        recipes: [
            {
                ...
                heroImage:
                    "https://images.unsplash.com/photo-1626082927389-c8a2a3cfcb9f?w=800&q=60",
                description:
                    "Grilled paneer cubes simmered in rich, spiced tomato gravy.",
                isPremium: true,
                isTrending: true,
                servings: 4,
                cuisine: "Indian",
            ...
            },
            {
                ...
                heroImage:
                    "https://images.unsplash.com/photo-1601972599720-b7a76a2d42a4?w=800&q=60",
                description:
                    "Decadent molten chocolate cake served warm with vanilla ice cream.",
                isPremium: false,
                isTrending: false,
                servings: 2,
                cuisine: "French",
            ...
            },
            {
                ...
                heroImage:
                    "https://images.unsplash.com/photo-1627308595121-8879f36a1eeb?w=800&q=60",
                description:
                    "Refreshing mango yogurt drink perfect for summer.",
                isPremium: false,
                isTrending: false,
                servings: 2,
                cuisine: "Indian",
        ...
        reviews: [
            ...
            {
                name: "Carlos Rivera",
                message: "Recipes are easy to follow and taste amazing!",
            },
        ],
    },
    followers: 12500,
...
const ChefDashboard = () => {
    ...
    const stats = {
        totalViews: chefProfile.recipes.reduce(
            (sum, r) => sum + (r.views || 0),
            0
        ),
        followers: userData.followers || 0,
        earnings: Math.round(
            chefProfile.subscriptionPrice * (userData.followers / 10)
        ),
            ...
            <div className="container mx-auto px-4 py-8 space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-500">
                            Track your recipes, followers, and performance.
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            onClick={() =>
                                navigate(`/profile/${MOCK_USER._id}`)
                            }
                        >
                            View Profile
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div
                            key={label}
                            className="card bg-base-100 shadow border border-orange-100"
                        >
                    ...
                    {chefProfile.recipes.length > 0 ? (
                        ...
                        <div className="card bg-base-100 shadow text-center p-10">
                            ...
                            <p className="text-gray-500 mb-4">
                                Start creating recipes to see your analytics
                                here.
                            </p>
                            <button
