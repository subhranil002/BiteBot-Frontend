    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
      ...
      <div className="mt-20 mb-10">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed text-base sm:text-lg mt-2">
                {chef.bio}
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {chef.specialties.map((s, i) => (
                <span
                  key={i}
                  className="px-3 py-1 text-sm rounded-full border border-orange-300 text-orange-600 bg-orange-50/50 backdrop-blur-sm hover:bg-orange-100 transition-colors"
                >
                  {s}
                </span>
              ))}
          ...
          <div className="flex flex-col sm:flex-row md:flex-col gap-3">
            <button
              className={`px-5 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all shadow-md shadow-orange-200/50 ${
                subscribed
                  ? "bg-white/70 border border-orange-200 text-orange-600 hover:bg-orange-50"
                  : "bg-gradient-to-r from-orange-500 to-red-500 text-white hover:shadow-orange-400/60 hover:-translate-y-1"
              }`}
            ...
            <button className="px-5 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 bg-white/70 border border-orange-200 text-gray-700 hover:bg-orange-50 transition-all shadow-md shadow-orange-100/40">
              <FaRegComment className="w-4 h-4 text-orange-400" />
              Message Chef
            </button>

            <button className="px-5 py-3 rounded-xl font-semibold flex items-center justify-center gap-2 bg-white/60 border border-orange-100 text-gray-700 hover:bg-orange-50 transition-all shadow-md shadow-orange-100/40">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-10">
          {[
            ...
            <div
              key={i}
              className="p-5 text-center bg-white/70 backdrop-blur-md border border-orange-100 rounded-2xl shadow-sm hover:shadow-orange-200/60 transition-all hover:-translate-y-1"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white/70 backdrop-blur-md border border-orange-100 p-6 rounded-2xl shadow-md shadow-orange-200/50">
            ...
            <p className="text-gray-600 italic mb-4">
              “I believe that great food starts with great ingredients and a
              passion for bringing people together. Every recipe I share comes
              from years of experience and a desire to make restaurant-quality
            ...
            <div className="flex flex-wrap gap-2">
              {chef.specialties.map((s, i) => (
                <span
                  key={i}
                  className="px-3 py-1 rounded-full text-sm border border-orange-300 text-orange-600 bg-orange-50/50"
                >
                  {s}
                </span>
              ))}
        ...
        <div className="space-y-6">
          {/* Social */}
          <div className="bg-white/70 backdrop-blur-md border border-orange-100 p-5 rounded-2xl shadow-md shadow-orange-200/50">
            <h4 className="text-lg font-bold mb-3 text-gray-800">
              Connect with {chef.name.split(" ")[0]}
            </h4>
            <div className="space-y-2">
              {["Instagram", "YouTube Channel", "Personal Website"].map(
                (label, i) => (
                  <button
                    key={i}
                    className="w-full flex items-center justify-start gap-2 px-4 py-2 rounded-xl border border-orange-200 text-gray-700 hover:bg-orange-50 transition-all text-sm"
                  >
          ...
          <div className="bg-white/70 backdrop-blur-md border border-orange-100 p-5 rounded-2xl shadow-md shadow-orange-200/50">
            ...
            <div className="space-y-5">
              {SAMPLE_TESTIMONIALS.map((t, i) => (
                <div key={t.id} className="space-y-2 border-b border-orange-50 pb-3">
