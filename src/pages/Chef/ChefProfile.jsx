                ...
                <div className="container mx-auto px-4 py-10">
                        ...
                        <div className="space-y-4 max-w-2xl">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {profileData?.profile?.cuisine?.map((c, i) => (
                                    <div key={i} className="badge badge-outline border-orange-400 text-orange-500">
                                        {c}
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
                        {[
                            ...
                            {
                                label: "Chef Type",
                                value: profileData?.chefProfile?.subscriptionPrice > 0
                                    ? "Premium"
                                    : "Free",
                            },
                            {
                                label: "Average Rating",
                                value: profileData?.chefProfile?.averageRating?.toFixed(1) || "N/A",
                            },
                        ].map((stat, i) => (
                            <div key={i} className="card bg-base-100 shadow-sm border border-orange-100">
